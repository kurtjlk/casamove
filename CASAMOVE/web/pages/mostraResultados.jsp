                    ...
                    <div class="col-lg-12">
                        <div id="page">
                            ...
                            <div id="box">
                                ...
                                <div style="clear: both;"></div>
                                <c:choose>
                                    <c:when test="${param.listaDeBusca.Empty()}">
                                        <p>Desculpe, mas não encontramos nenhum resultado com "<strong>${param.termo}</strong>".</p>
                                    </c:when>
                                    <c:otherwise>
                                        <c:forEach items="${listaDeBusca}" var="item">
                                            <a href="detalhesProduto?cod=${item.codigo}">
                                                <div id="item" class="col-sm-4 text-center" style="height: 30%;">
                                                    ...
                                                    <span style="color:#d58512"><strong>Por:R$ ${item.valor}</strong></span>
